...
export default function NewsAside() {
  ...
  return (
    <aside className="mx-2 mb-8 mt-4 overflow-x-auto md:overflow-y-auto items-center">
      <h1 className="text-center font-bold">Articulos Recomendados</h1>
      <div className="overflow-x-auto md:overflow-y-auto mt-4 flex flex-row md:flex-col">
